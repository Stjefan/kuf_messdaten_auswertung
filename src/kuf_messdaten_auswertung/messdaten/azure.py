...
class MessdatenServiceV3:
    ...
    def get_estimated_single(self, messpunkt: Messpunkt, from_date: datetime, to_date: datetime) -> pd.DataFrame:
        ...
        data_dict = {
            ...
            "estimated_2": f"E{messpunkt.id}_estimated_2",
        }
    ...
    def get_richtungswertungsvantek_all_mps(self, ids_only: List[Messpunkt], from_date: datetime, to_date: datetime):

        df_mps = []
        for i in ids_only:
            df_mps.append(self.get_estimated_single(i, from_date, to_date))
...
if __name__ == "__main__":
    if True:
        ...
        from_date = datetime(2023, 4, 27, 0, 0, 0)
        to_date = datetime(2023, 4, 27, 10, 4, 0)
        ...
        df_1 = m.get_estimated_single(mp, from_date, to_date)
        df_2 = m.get_resudaten_single(mp, from_date, to_date)
        print(df_2)
    if False:
        cs = "postgresql://stjefan2:p057!Gres@kufi-postgres13.postgres.database.azure.com/foo3"
